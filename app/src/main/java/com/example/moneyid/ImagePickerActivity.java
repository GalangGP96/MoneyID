...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            Toast.makeText(getApplicationContext(), "Missing Image Picker", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(ImagePickerActivity.this,
                getPackageName() + ".provider", image);
    }
    private static String queryName(ContentResolver resolver, Uri uri) {
        Cursor returnCursor = resolver.query(uri, null, null, null,
                null);
